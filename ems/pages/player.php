...
if (isset($_GET['delete'])) {
    $sql = "DELETE FROM population_journals WHERE id = ?";
...
<main>
    <div class="player">
        ...
        <div class="buttons">
            <a class="Delete" href="addJournal.php?player=<?php echo $player ?>&type=normal">Tilføj rapport</a>
            ...
            <div class="table-responsive">
                <table id="big-text-table" class="table table-striped table-hover">
                    <tr>
                        ...
                        <?php
                        $stmt = $link->prepare("SELECT * FROM population_journals WHERE pid = ?");
                        $stmt->bind_param("i", $player);
                        $stmt->execute();
                        $result = $stmt->get_result();
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['damage_report'] ?></td>
                            <td>
    ...
    <script type="text/javascript">
        ...
        function openJournal(journalId) {
            var pdfUrl = 'generate_journal.php?id=' + journalId;
