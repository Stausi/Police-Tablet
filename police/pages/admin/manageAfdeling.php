...
if(isset($_GET['delete'])) {
    $sql = "DELETE FROM afdelinger WHERE afdelingID = ?";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_POST["afdelingsnavn"])){
        if(empty(trim($_POST["afdelingsnavn"]))){
            ...
            $sql = "SELECT afdelingID FROM afdelinger WHERE afdeling = ?";
        ...
        if(empty($afdeling_err)){
            $sql = "INSERT INTO afdelinger (afdeling) VALUES (?)";
        ...
        $sql = "UPDATE afdelinger SET order_number = ? WHERE afdeling = ?";
